...
import "../../../../dist/BetterHero.js";
declare const BetterHero: {
  render: (el: HTMLElement, context?: object, sourceUrl?: string) => void;
};

export interface IBetterHeroWebPartProps {
  description: string;
  lgBreakPointCols: number;
}
...
export default class BetterHeroWebPart extends BaseClientSideWebPart<IBetterHeroWebPartProps> {
  ...
  public render(): void {
    ...
    BetterHero.render(this.domElement, this.context);
  }
